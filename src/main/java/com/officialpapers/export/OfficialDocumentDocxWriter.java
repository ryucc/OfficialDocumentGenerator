...
/**
 * Writes OfficialDocumentData into an XWPFDocument structure.
 *
 * <p>Responsibilities:
 * <ul>
 *   <li>Document structure manipulation (trim, remove blanks)</li>
 *   <li>Content writing (tables, paragraphs, formatting)</li>
 *   <li>POI API knowledge</li>
 * </ul>
 *
 * <p>Does NOT handle:
 * <ul>
 *   <li>Template loading</li>
 *   <li>File I/O or serialization</li>
...
class OfficialDocumentDocxWriter {
    ...
    OfficialDocumentDocxWriter(OfficialDocumentGeneratorConfig config) {
        this.config = config;
    }

    /**
     * Writes data into an XWPFDocument.
     *
     * @param document the document to populate (will be modified in-place)
     * @param data the data to write
     * @return the same document instance (for method chaining)
     */
